...
async function createTestUsers() {
  try {
    ...
    const testUsers = [
      {
        ...
        email: 'jeannine.thiombiano@test.com',
        password: 'password123'
      },
      {
        name: 'Vaimbamba Armand',
        email: 'vaimbamba.armand@test.com', 
        password: 'password123'
      },
      {
        name: 'Bounkoungou Chantal',
        email: 'chantal.bounkoungou@test.com',
        password: 'password123'
      }
    ];
    ...
    console.log('\n📱 Login Credentials:');
    console.log('Email: jeannine.thiombiano@test.com | Password: password123');
    console.log('Email: vaimbamba.armand@test.com | Password: password123');
    console.log('Email: chantal.bounkoungou@test.com | Password: password123');
